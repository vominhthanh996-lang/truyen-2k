...
const STORY_ART_PACKS = {
  ...
  "toi-tro-ve-30-ngay-truoc-khi-thanh-pho-chim:c002": {
    title: "Cảnh minh họa chương 2",
    intro: "20 khung hình theo mạch Lâm An tách nguồn nước, thuê kho bí mật, mua vật tư và bị những ánh mắt đầu tiên bám theo.",
  ...
  "toi-tro-ve-30-ngay-truoc-khi-thanh-pho-chim:c005": {
    title: "Cảnh minh họa chương 5",
    intro: "20 khung hình theo mạch chai nhựa rỗng, cái bẫy kho mồi, và cuộc đối đầu đêm mưa với Minh.",
    images: Array.from({ length: 20 }, (_, index) => ({
      src: `assets/story-art/toi-tro-ve-30-ngay-truoc-khi-thanh-pho-chim/c005/c005-scene-${String(index + 1).padStart(2, "0")}.webp`,
      alt: `Tôi Trở Về 30 Ngày Trước Khi Thành Phố Chìm - chương 5 - cảnh ${index + 1}`
    }))
  },
  "toi-tro-ve-30-ngay-truoc-khi-thanh-pho-chim:c006": {
    title: "Cảnh minh họa chương 6",
    intro: "20 khung hình theo mạch tầng mười bảy trở thành chiến trường camera, hàng xóm, thang máy và tin đồn.",
    images: Array.from({ length: 20 }, (_, index) => ({
  ...
  "toi-tro-ve-30-ngay-truoc-khi-thanh-pho-chim:c008": {
    title: "Cảnh minh họa chương 8",
    intro: "20 khung hình theo mạch luật mới trong chợ cũ, Sỏi xuất hiện và dấu hiệu nước trào ngược tới sớm hơn ký ức.",
    images: Array.from({ length: 20 }, (_, index) => ({
